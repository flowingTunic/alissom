...
bancoDados = {}
if(os.path.exists('trabalhoAlissom.py\BancoDados.json')): # verificando se o arquivo existe.
    with open('trabalhoAlissom.py\BancoDados.json', 'r') as arquivo:
        bancoDados = json.load(arquivo)
    print("Banco de dados carregado.")
else:
    print("Banco de dados não encontrado.")
    print("Iniciando banco de dados...")
    with open('trabalhoAlissom.py\BancoDados.json', 'w') as arquivo:
